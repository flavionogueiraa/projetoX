module.exports = {
  ...
  theme: {
    colors: {
      ...
      "primary-pure": "#F27405",
      "primary-pure-light": "#F5F8FB",
      "primary-pure-light-o": "rgba(191, 19, 4, 0.1)",
      "primary-pure-dark": "#8C0D03",
      "primary-pure-4": "#F5F8FB",
      "primary-pure-40": "#8C0D03",
      "primary-pure-op-4": "rgba(191, 19, 4, 0.4)",
      "primary-bg": "#F7F9FB",
      "bg-sidebar-level": "#F5F8FB",
      negative: "#EC3539",
      positivo: "#A6CE44",
      "borda-10": "#E6E6E6",
      "primary-blue": "#9bb8f2",
